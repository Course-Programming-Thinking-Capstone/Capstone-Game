...
namespace GameScene.GameCondition
{
    public class ConditionController : ClickDragController
    {
        ...
        [SerializeField] private ConditionView view;
        ...
        private void OnClickedSelector(InteractionItem selectedObj)
        {
            ...
            if (selectedObj.SelectType == SelectType.Condition)
            {
                var objLoop = SimplePool.Spawn(model.ConditionPrefab);
                Condition selectedScript = objLoop.GetComponent<Condition>();
